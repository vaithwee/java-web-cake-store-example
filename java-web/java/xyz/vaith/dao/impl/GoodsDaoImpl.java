...
public class GoodsDaoImpl implements GoodsDao {
    ...
    public List<Map<String, Object>> getHotList() throws SQLException {
        ...
        String sql = "select g.id, g.name, g.cover, g.image1, g.image2, g.intro, g.price, g.stock, t.id typeid, t.name typename from recommend r, goods g, type t where type = 2 and r.goods_id = g.id and g.type_id = t.id;";
